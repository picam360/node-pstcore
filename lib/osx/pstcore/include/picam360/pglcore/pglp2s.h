...
void FUNC_DEF pglp2s_set_bgcolor(uint8_t *rgb);
void FUNC_DEF pglp2s_set_bgcolor_yuv(uint8_t *yuv);
...
void FUNC_DEF pglp2s_render(TextureParams *tpo, GLfloat *quat, GLfloat fov,
                            GLfloat edge_r, GLfloat gain_theta);
